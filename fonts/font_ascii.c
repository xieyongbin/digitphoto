...
static int ascii_get_font_bitmap(const unsigned int code, struct font_bitmap *pfont_bitmap)
{
	...
	pfont_bitmap->bitmap_var.x_max   = pen_x + 8;
	pfont_bitmap->bitmap_var.y_max   = pen_y;
	pfont_bitmap->bitmap_var.bpp      = 1;
	pfont_bitmap->bitmap_var.pitch    = 1;
	pfont_bitmap->bitmap_var.pbuf = (unsigned char *)&fontdata_8x16[code * 16];;	

	pfont_bitmap->next_disp.x = pen_x + 8;
