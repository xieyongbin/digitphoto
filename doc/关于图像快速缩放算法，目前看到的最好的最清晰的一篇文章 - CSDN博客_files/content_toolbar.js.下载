        ...
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="write-bolg-btn csdn-tracking-statistics tracking-click" data-mod="popu_370"><a class="" href="http://write.blog.csdn.net/postedit?ref=toolbar" target="_blank"><i class="iconfont-toolbar toolbar-icon_boke"></i></a></li>\
              ...
              <li class="userLogin">\
                <div class="loginCenter"><a href="http://my.csdn.net?ref=toolbar" target="_blank"><img class="login_img" src="'+currUser.avatar+'"><div class="toolbar-circle"></div><span class="userName">'+currUser.userNick+'</span><i class="iconfont-toolbar toolbar-xiajiantou"></i></a></div>\
